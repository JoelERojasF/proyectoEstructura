 ...
 */
public class ListaEnlazadaCircularTest {
    
    private ListaEnlazadaCircular<Integer> lista;
    ...
    void testCircularidad() throws Exception {
        ...
        // último nodo
        NodoSimple<Integer> ultimo = lista.inicio;
        for (int i = 0; i < lista.tamanio() - 1; i++) {
            ultimo = ultimo.getSig();
        }

        // comprobar enlaces circulares
        assertEquals(lista.inicio, ultimo.getSig()); // último → inicio
    }
}